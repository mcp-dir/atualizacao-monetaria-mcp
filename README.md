...
### Correção de valores por IPCA, INPC, IGP-M, SELIC e TR, para IA

**Atualização monetária** automática para IA. Corrija qualquer valor por IPCA, INPC, IGP-M, SELIC, TR e outros índices oficiais, com juros, multa e honorários. Índices buscados ao vivo no BACEN e no IBGE, sem login.

- 💰 **Corrige qualquer valor** entre duas datas pelo índice escolhido
...
**Manual** (se o deeplink não abrir): [claude.ai/customize/connectors](https://claude.ai/customize/connectors?surface=cowork) → **+** → **Adicionar conector personalizado** → cole **Nome** `Atualização Monetária` e **URL** `https://api.mcp.ai/p_atualizacao-monetaria`.

### Cursor

[➕ Instalar Atualização Monetária no Cursor](cursor://anysphere.cursor-deeplink/mcp/install?name=atualizacaomonetaria&config=eyJ1cmwiOiJodHRwczovL2FwaS5tY3AuYWkvcF9hdHVhbGl6YWNhby1tb25ldGFyaWEifQ==)

### VS Code (Copilot Chat)

[➕ Instalar Atualização Monetária no VS Code](vscode:mcp/install?name=atualizacaomonetaria&config=%7B%22type%22%3A%22http%22%2C%22url%22%3A%22https%3A%2F%2Fapi.mcp.ai%2Fp_atualizacao-monetaria%22%7D)
...
Corrija R$ 5.000 pela SELIC dos últimos 12 meses
```
...
MIT — veja [LICENSE](LICENSE). O servidor MCP em `api.mcp.ai/p_atualizacao-monetaria` é proprietário (hosted); este repositório (manifestos, docs, skills) é MIT.
